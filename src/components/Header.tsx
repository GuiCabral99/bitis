...
export default () => {
  ...
  return (
    <>
      ...
      <div className="bg-primary shadow-md shadow-gray-800/60 h-20 z-10 w-full flex items-center justify-between lg:justify-center px-mobile tablet:px-tablet desktop:px-desktop fixed font-title text-black">
        <div className="flex w-full justify-between desktop:justify-center desktop:w-[1100px]">
          ...
          <div className="hidden flex-1 desktop:flex justify-end items-center space-x-8">
            ...
            <Link
              href="https://www.facebook.com/bitisfoodpizza"
              target="_blank"
            >
