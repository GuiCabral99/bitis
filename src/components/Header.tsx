...
export default () => {
  return (
    <>
      <div className="bg-primary h-20 w-full flex items-center justify-between lg:justify-center px-mobile tablet:px-tablet desktop:px-desktop fixed font-title text-black z-20">
